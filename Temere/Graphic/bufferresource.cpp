...
BufferResource::BufferResource(std::vector<Vertex*> &vertices, std::vector<GLuint> &indices, std::string &fileName)
{
	mFileName = fileName;
...
void BufferResource::init(std::vector<Vertex*> &vertices, std::vector<GLuint> &indices)
{
